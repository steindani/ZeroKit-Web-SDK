declare module 'zkit_sdk/src/config' {
	/**
...
declare module 'zkit_sdk/src/utils/deferred' {
...
declare module 'zkit_sdk/src/iframes/iframeHandler' {
	/// <reference types="core-js" />
	/**
...
declare module 'zkit_sdk/src/iframes/inputIframe' {
	/// <reference types="core-js" />
	import { IframeHandler } from 'zkit_sdk/src/iframes/iframeHandler';
	/**
...
declare module 'zkit_sdk/src/utils/pathData' {
...
declare module 'zkit_sdk/src/users/loginIframe' {
	/// <reference types="core-js" />
	import { InputIframe } from 'zkit_sdk/src/iframes/inputIframe';
	import { IframeHandler } from 'zkit_sdk/src/iframes/iframeHandler';
	import { PathData } from 'zkit_sdk/src/utils/pathData';
	/**
...
declare module 'zkit_sdk/src/utils/passwordMetrics' {
...
declare module 'zkit_sdk/src/utils/rejection' {
	/// <reference types="core-js" />
	/**
...
declare module 'zkit_sdk/src/users/registerIframe' {
	/// <reference types="core-js" />
	import { InputIframe } from 'zkit_sdk/src/iframes/inputIframe';
	import { PasswordMetrics } from 'zkit_sdk/src/utils/passwordMetrics';
...
declare module 'zkit_sdk/src/tresors/acceptInvitationLinkIframe' {
	/// <reference types="core-js" />
	import { InputIframe } from 'zkit_sdk/src/iframes/inputIframe';
	/**
...
declare module 'zkit_sdk/src/tresors/createLinkResponse' {
...
declare module 'zkit_sdk/src/tresors/createInvitationLinkIframe' {
	/// <reference types="core-js" />
	import { InputIframe } from 'zkit_sdk/src/iframes/inputIframe';
	import { PasswordMetrics } from 'zkit_sdk/src/utils/passwordMetrics';
	import { CreateLinkResponse } from 'zkit_sdk/src/tresors/createLinkResponse';
...
declare module 'zkit_sdk/src/users/changePasswordIframe' {
	/// <reference types="core-js" />
	import { InputIframe } from 'zkit_sdk/src/iframes/inputIframe';
	import { PasswordMetrics } from 'zkit_sdk/src/utils/passwordMetrics';
...
declare module 'zkit_sdk/src/iframes/iframes' {
	import { LoginIframe } from 'zkit_sdk/src/users/loginIframe';
	import { RegisterIframe } from 'zkit_sdk/src/users/registerIframe';
	import { AcceptInvitationLinkIframe } from 'zkit_sdk/src/tresors/acceptInvitationLinkIframe';
	import { CreateInvitationLinkIframe } from 'zkit_sdk/src/tresors/createInvitationLinkIframe';
	import { ChangePasswordIframe } from 'zkit_sdk/src/users/changePasswordIframe';
	import { IframeHandler } from 'zkit_sdk/src/iframes/iframeHandler';
	/**
...
declare module 'zkit_sdk/src/encryption/encryption' {
	/// <reference types="core-js" />
	/**
...
declare module 'zkit_sdk/src/tresors/tresors' {
	/// <reference types="core-js" />
	/**
...
declare module 'zkit_sdk/src/tresors/invitationLinkPublicInfo' {
	/**
...
declare module 'zkit_sdk/src/tresors/invitationLinks' {
	/// <reference types="core-js" />
	import { CreateLinkResponse } from 'zkit_sdk/src/tresors/createLinkResponse';
	import { InvitationLinkPublicInfo } from 'zkit_sdk/src/tresors/invitationLinkPublicInfo';
	/**
...
declare module 'zkit_sdk/src/users/user' {
	/// <reference types="core-js" />
	/**
...
declare module 'zkit_sdk/src/index' {
	export { getAcceptInvitationLinkPasswordIframe, wrapAcceptInvitationLinkPasswordIframe, getChangePasswordIframe, wrapChangePasswordIframe, getCreateInvitationLinkPasswordIframe, wrapCreateInvitationLinkPasswordIframe, getLoginIframe, wrapLoginIframe, getRegistrationIframe, wrapRegistrationIframe, setup } from 'zkit_sdk/src/iframes/iframes';
	export { createTresor, shareTresor, kickFromTresor } from 'zkit_sdk/src/tresors/tresors';
	export { createInvitationLinkNoPassword, acceptInvitationLinkNoPassword, getInvitationLinkInfo } from 'zkit_sdk/src/tresors/invitationLinks';
	export { logout, whoAmI } from 'zkit_sdk/src/users/user';
	export { encrypt, encryptBytes, encryptBlob, decrypt, decryptBytes, decryptBlob } from 'zkit_sdk/src/encryption/encryption';

}
declare module 'zkit_sdk' {
	import main = require('zkit_sdk/src/index');
	export = main;
}
